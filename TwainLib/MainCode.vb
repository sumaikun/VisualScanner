...
Public Module TwainOperations
    ...
    Public Function ScanIt(Optional ByVal ScannerInfo As String = "", Optional ByVal filename As String = "test")
        Dim TW As New TwainHandler
        TW.SelectSourceAndScan(".jpg", True, ScannerInfo, filename)
        TW.Close()
        TW.Dispose()
    End Function
...
#End Region
    ...
    Public Class TwainHandler
        ...
        Private MainfileName As String = "test"
        ...
        Public Function SelectSourceAndScan(Optional ByVal PrefferedImageExtension As String = ".jpg", Optional ByVal CloseSourceAfterImgTransfer As Boolean = True, Optional ByVal ScannerInfo As String = "", Optional ByVal SfileName As String = "") As List(Of String)
            ...
            If SfileName IsNot "" Then
                MainfileName = SfileName
            End If
        ...
        Public Function PreFilterMessage(ByRef m As Message) As Boolean Implements IMessageFilter.PreFilterMessage
            ...
            Select Case cmd
                ...
                Case TwainCommand.TwainCommand_TransferReady
                    ...
                    Console.WriteLine("transfiero a la antigua")
                    Dim pics = TwainObj.TransferPictures(ImageExtension, MainfileName)

                    'Console.WriteLine("transfiero a la nueva")'
                    'TwainObj.TransferImage()'
    ...
    Public Class Twain
        ...
        Public Function TransferImage()
            ...
            Do
                ...
                ' create temp file
                Dim FilePath = "C:\Users\JVega\Documents\Imagenes_aplicacion"

                ' save image to disk
                If Not SaveImageDIB(FilePath & ".jpg", bmpptr, pixptr) Then
        ...
        Public Function TransferPictures(ByVal ImageExtension As String, Optional ByVal MainfileName As String = "test") As List(Of String)
            ...
            Do
                ...
                Dim FilePath = System.IO.Path.GetTempPath & MainfileName
                'Dim FilePath = "C:\" & "IMAGEN_PRUEBA"'
                ...
                If Not SaveImageDIB(FilePath & ImageExtension, bmpptr, pixptr) Then
                    ' probably an error happened, so don't store anything
                Else
